...
class HuberRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/huber_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/huber_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/huber_error_distribution.png"
        )
        plt.close()

dr = HuberRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/huber_regressor.pkl"
)
