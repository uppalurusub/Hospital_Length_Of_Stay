...
class OMPRegressorTrainer:
    ...
    def __init__(self):
        ...
        self.model_name = "OrthogonalMatchingPursuitRegressor"
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/omp_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/omp_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/omp_error_distribution.png"
        )
        plt.close()

dr = OMPRegressorTrainer()

print(
    "\nOMP REGRESSOR RESULTS"
)
results = dr.train(
    X_train=X_train,
    X_test=X_test,
...
joblib.dump(
    dr.model,
    "saved_artifacts/omp_regressor.pkl"
)
