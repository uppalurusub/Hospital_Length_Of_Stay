...
class GradientBoostingRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/gbm_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/gbm_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/gbm_error_distribution.png"
        )
        plt.close()

dr = GradientBoostingRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/gbm_regressor.pkl"
)
