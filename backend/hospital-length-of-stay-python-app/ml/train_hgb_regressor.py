...
class HistGradientBoostingRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/hgb_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/hgb_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/hgb_error_distribution.png"
        )
        plt.close()

dr = HistGradientBoostingRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/hgb_regressor.pkl"
)
