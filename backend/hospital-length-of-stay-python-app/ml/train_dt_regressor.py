...
class DecisionTreeRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/dt_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/dt_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/dt_error_distribution.png"
        )
        plt.close()

dr = DecisionTreeRegressorTrainer()

print(
    "\nDecisionTreeRegressor REGRESSOR RESULTS"
)
results = dr.train(
    X_train=X_train,
    X_test=X_test,
...
joblib.dump(
    dr.model,
    "saved_artifacts/dt_regressor.pkl"
)
