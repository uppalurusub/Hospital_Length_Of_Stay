...
class PassiveAggressiveRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/par_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/par_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/par_error_distribution.png"
        )
        plt.close()

dr = PassiveAggressiveRegressorTrainer()

print(
    "\PAR REGRESSOR RESULTS"
)
results = dr.train(
    X_train=X_train,
    X_test=X_test,
...
joblib.dump(
    dr.model,
    "saved_artifacts/par_regressor.pkl"
)
