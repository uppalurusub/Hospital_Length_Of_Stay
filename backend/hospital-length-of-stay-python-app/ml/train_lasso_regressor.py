...
class LassoRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/lasso_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/lasso_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/lasso_error_distribution.png"
        )
        plt.close()

dr = LassoRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/lasso_regressor.pkl"
)
