...
class StackingRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/str_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/str_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/str_error_distribution.png"
        )
        plt.close()

dr = StackingRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/str_regressor.pkl"
)
