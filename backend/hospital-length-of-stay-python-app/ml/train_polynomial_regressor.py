...
class PolynomialRegressorTrainer:
    ...
    def __init__(self):
        ...
        self.model_name = "PolynomialRegression"
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/polynomial_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/polynomial_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/polynomial_error_distribution.png"
        )
        plt.close()

pr = PolynomialRegressorTrainer()
...
joblib.dump(
    pr.model,
    "saved_artifacts/polynomial_regressor.pkl"
)
