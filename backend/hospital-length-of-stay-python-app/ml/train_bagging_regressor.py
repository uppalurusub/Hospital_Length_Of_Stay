...
class BaggingRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/br_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/br_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/br_error_distribution.png"
        )
        plt.close()

dr = BaggingRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/br_regressor.pkl"
)
