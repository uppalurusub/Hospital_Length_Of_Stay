...
class BayesianRidgeTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/bayesianridge_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/bayesianridge_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/bayesianridge_error_distribution.png"
        )
        plt.close()

dr = BayesianRidgeTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/bayesiain_ridge_regressor.pkl"
)
