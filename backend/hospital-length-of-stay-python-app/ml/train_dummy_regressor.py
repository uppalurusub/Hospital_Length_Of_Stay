...
class DummyRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/dummy_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/dummy_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/dummy_error_distribution.png"
        )
        plt.close()

dr = DummyRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/dummy_regressor.pkl"
)
