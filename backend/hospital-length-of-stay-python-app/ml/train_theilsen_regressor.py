...
class TheilSenRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/theilsen_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/theilsen_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/theilsen_error_distribution.png"
        )
        plt.close()

dr = TheilSenRegressorTrainer()

print(
    "\nTHEILSEN REGRESSOR RESULTS"
)
results = dr.train(
    X_train=X_train,
    X_test=X_test,
...
joblib.dump(
    dr.model,
    "saved_artifacts/theilsen_regressor.pkl"
)
