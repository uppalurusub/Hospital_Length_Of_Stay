...
class VotingRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/vr_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/vr_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/vr_error_distribution.png"
        )
        plt.close()

dr = VotingRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/vr_regressor.pkl"
)
