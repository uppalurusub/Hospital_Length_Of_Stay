...
class RandomForestRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/rf_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/rf_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/rf_error_distribution.png"
        )
        plt.close()

dr = RandomForestRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/rf_regressor.pkl"
)
