...
class MultipleRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/multiple_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/multiple_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/multiple_error_distribution.png"
        )
        plt.close()

mr = MultipleRegressorTrainer()

print(
    "MULTIPLW REGRESSOR RESULTS"
)
results = mr.train(
    X_train=X_train,
    X_test=X_test,
...
joblib.dump(
    mr.model,
    "saved_artifacts/multiple_regressor.pkl"
)
