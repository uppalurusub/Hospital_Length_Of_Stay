...
class RansacRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/ransac_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/ransac_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/ransac_error_distribution.png"
        )
        plt.close()

dr = RansacRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/ransac_regressor.pkl"
)
