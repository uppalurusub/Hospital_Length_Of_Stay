...
class ElasticNetRegressorTrainer:
    ...
    def __init__(self):
        ...
        self.model_name = "ElasticNetRegressor"
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/elasticnet_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/elasticnet_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/elasticnet_error_distribution.png"
        )
        plt.close()

dr = ElasticNetRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/elasticnet_regressor.pkl"
)
