...
class KNeighborsRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/knn_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/knn_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/knn_error_distribution.png"
        )
        plt.close()

dr = KNeighborsRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/knn_regressor.pkl"
)
