...
blend_features = np.column_stack([
    ...
    et.predict(X_blend),
    xgb.predict(X_blend),
    lgbm.predict(X_blend)
])"""


blend_features = np.column_stack([
    model.predict(X_blend)
    for model in base_models
])

print("\nblend_features: ")
print(blend_features.shape)
...
print("\ntest_meta_features: ")
print(test_meta_features.shape)

class BlendingRegressorTrainer:
    ...
    def __init__(self):
        ...
        self.model_name = "BlendingRegressor"
    ...
    def train(
        ...
        print("blend_features Shape: ",blend_features.shape)
        print("test_meta_features Shape: ",test_meta_features.shape)
        print("y_test Shape: ",y_test.shape)
        print("y_blend Shape: ",y_blend.shape)
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/blr_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/blr_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/blr_error_distribution.png"
        )
        plt.close()

dr = BlendingRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/blr_regressor.pkl"
)
