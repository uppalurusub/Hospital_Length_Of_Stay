...
class LarsRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/lars_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/lars_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/lars_error_distribution.png"
        )
        plt.close()

dr = LarsRegressorTrainer()

print(
    "\nLARS REGRESSOR RESULTS"
)
results = dr.train(
    X_train=X_train,
    X_test=X_test,
...
joblib.dump(
    dr.model,
    "saved_artifacts/lars_regressor.pkl"
)
