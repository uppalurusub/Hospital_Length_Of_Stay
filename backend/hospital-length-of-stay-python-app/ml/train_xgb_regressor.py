...
class XGBRegressorTrainer:
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/xgb_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/xgb_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/xgb_error_distribution.png"
        )
        plt.close()

dr = XGBRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/xgb_regressor.pkl"
)
