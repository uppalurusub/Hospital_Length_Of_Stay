...
class LassoLarsRegressorTrainer:
    ...
    def __init__(self):
        ...
        self.model_name = "LassoLarsRegressor"
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/lassolars_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/lassolars_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/lassolars_error_distribution.png"
        )
        plt.close()

dr = LassoLarsRegressorTrainer()

print(
    "\nLASSO LARS REGRESSOR RESULTS"
)
results = dr.train(
    X_train=X_train,
    X_test=X_test,
...
joblib.dump(
    dr.model,
    "saved_artifacts/lassolars_regressor.pkl"
)
