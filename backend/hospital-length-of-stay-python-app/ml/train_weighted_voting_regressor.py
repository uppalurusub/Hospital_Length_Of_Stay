...
class WeightedVotingRegressorTrainer:
    ...
    def __init__(self):
        ...
        self.model = VotingRegressor(
            ...
            weights=[1, 1, 3, 4]   # weighted ensemble

        )
        self.model_name = "WeightedVotingRegressor"
    ...
    def visualize(
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/wvr_actual_vs_predicted.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/wvr_residual_plot.png"
        )
        plt.close()
        ...
        #plt.show()
        plt.savefig(
            "saved_artifacts/wvr_error_distribution.png"
        )
        plt.close()

dr = WeightedVotingRegressorTrainer()
...
joblib.dump(
    dr.model,
    "saved_artifacts/wvr_regressor.pkl"
)
